...
public class ioTest {
    ...
    // 입력 스트림 : 대상으로부터 자료를 읽어 들이는 스트림 (FileInputStream, FileReader, BufferedInputStream, BufferedReader 등)
    ...
    // 기반 스트림을 감싸고 있는 느낌
    // 버퍼 기능을 추가한다거나, 바이트를 문자로 바꿔준다거나, 객체를 그대로 저장할 수 있도록 바이트 스트림을 만들어주거나 등등
}
